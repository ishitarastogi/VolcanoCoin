// SPDX-License-Identifier:UNLICENSED //3. add a license identifer
...
contract VolcanoCoin {  //4 create contract named VolcanoCoin
    ...
    //   1.address.balance (can hold ether of both account address and contract and can give their balance)
    //     can't perform operations like addition and subtraction on address.balance
